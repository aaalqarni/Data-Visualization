...
public class RadialGraphView extends Display {
    ...
    //public static final String DATA_FILE = "Twitter_Networks_06.graphml";
    public static final String DATA_FILE = "/Arabic_Text_Rank.xml";
    ...
    public RadialGraphView(Graph g, String label) {
        ...
        m_nodeRenderer.setRoundedCorner(50,100);
        m_edgeRenderer = new EdgeRenderer(Constants.EDGE_TYPE_LINE);
         m_edgeRenderer.setArrowType( Constants.EDGE_ARROW_FORWARD);
        m_edgeRenderer.setArrowHeadSize(5, 20);
        m_edgeRenderer.setDefaultLineWidth(frameRate);
    ...
    public static JPanel demo(Graph g, final String label) {        
        ...
        search.setBorder(BorderFactory.createLineBorder(Color.yellow));
