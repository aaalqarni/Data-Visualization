...
public class ProcessGraphView extends JPanel {
    ...
    public ProcessGraphView(Graph g,  String label, String agLabel) {
...
//        m_vis.setInteractive(AGGR, null, true);
    ...
    public static JFrame demo(Graph g, final String label, String agLabel) {
        ...
        final ProcessGraphView view = new ProcessGraphView(g, label, agLabel);
    ...
    public abstract static class GraphMenuAction extends AbstractAction {
        ...
        public GraphMenuAction(String name, String accel, ProcessGraphView view) {
    ...
    public static class OpenGraphAction extends AbstractAction {
        ...
        public OpenGraphAction(ProcessGraphView view) {
