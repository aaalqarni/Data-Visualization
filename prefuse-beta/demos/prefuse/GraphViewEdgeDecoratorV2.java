...
public class GraphViewEdgeDecoratorV2 extends JPanel {
	...
	edgeStrokeColor.add(ExpressionParser.predicate("relation == 'friends'"), ColorLib.rgba(200,0,0,100));
	edgeStrokeColor.add(ExpressionParser.predicate("relation == 'team mates'"), ColorLib.rgba(0,200,0,100));
	edgeStrokeColor.add(ExpressionParser.predicate("relation == 'colleagues'"), ColorLib.rgba(0,0,200,100));
...
//	opanel.add(overview);
	...
	drf.add(new InGroupPredicate(EDGE_DECORATORS), new LabelRenderer("relation"));
	...
	String datafile = "socialnetRelations.xml";
	String label = "name";
	...
	private GraphViewEdgeDecoratorV2 m_view;
	public GraphMenuAction(String name, String accel, GraphViewEdgeDecoratorV2 view) {
	    m_view = view;
	...
	public OpenGraphAction(GraphViewEdgeDecoratorV2 view) {
	    m_view = view;
